...
class TownCar(Car):
    ...
    def show_speed(self):
        if Car.speed >60:
            print(f'Вы едете {Car.speed} км/ч. Это слишком быстро!')
        else:
            print(f'Вы едете {Car.speed} км/ч. Так держать!')
...
class SportCar(Car):
    ...
    def show_speed(self):
        if Car.speed < 60:
            print(f'Вы едете {Car.speed} км/ч. Добавьте газу!')
        else:
            print(f'Вы едете {Car.speed} км/ч. Вы точно приедете первым!')
...
class PoliceCar(Car):
    ...
    def show_speed(self):
        if Car.speed < 60:
            print(f'Вы едете {Car.speed} км/ч. Добавьте газу, преступник уходит!')
        else:
            print(f'Вы едете {Car.speed} км/ч. Виу-виу, поймать преступника!')
